...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Raja") || (event.body.toLowerCase() == "Raja Ke") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "Tor Boss Ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Raja ❤️ হাই আমি মেছেন্জার ROBOT  আামার জামাই রাজা বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "Sala ami Tor Boss") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি জামাই মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার জামাই রাজার এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার জামাই রাজার এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mimi") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার জামাইচ রাজার এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@কা্ঁরে্ঁন্ট্ঁ সু্ঁন্দ্ঁর্ঁ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰 আমার জামাই রাজা' KE Mention করবি না😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "umma") || (event.body.toLowerCase() == "kiss me")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম  সুন্দরী এসো আমার জামাই রাজার সাথে ঘুমাবো😷", threadID);
   };

   if ((event.body.toLowerCase() == "Nam") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
   ...
   if ((event.body.toLowerCase() == "আজ কেউ নেই বলে") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার জামাই কে একটা গফ দে<🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
     return api.sendMessage("হুম জামাই আমি তোমাকে রাইতে ভলোপাসি <🥵", threadID);
   };

   if ((event.body.toLowerCase() == "Ami Raja") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হ্যা জামাই কেমন আছেন..?☺️", threadID);
   };
  mess = "{name}"
